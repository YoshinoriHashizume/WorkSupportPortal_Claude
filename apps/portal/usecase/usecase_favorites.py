...
from apps.portal.domain.menu import MENU_BY_KEY, MENU_GROUP_BY_KEY, MENU_GROUPS, MENU_ITEMS
from apps.portal.domain.menu_access import menu_item_payload
from apps.portal.domain.ports import FavoriteRepository
