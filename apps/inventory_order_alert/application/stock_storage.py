...
def import_slims_csv_text(
    ...
    *,
    ...
    from apps.inventory_order_alert.application.summary_storage import StockImportInfo, run_summary_aggregation
    ...
    from apps.inventory_order_alert.models import InventoryOrderAlertSummarySnapshot
...
def load_latest_stock_lines() -> tuple[list[SlimsStockLocationLine], object | None]:
    from apps.inventory_order_alert.application.summary_storage import StockImportInfo
