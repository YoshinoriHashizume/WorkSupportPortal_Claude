...
from apps.receipt_comparison.domain.comparison_display import pending_matches
from apps.receipt_comparison.infrastructure.session import pending_comparison_session as session
...
class HttpPendingComparisonStore:
    ...
    def rows_for_register(self, pending: dict[str, object], post_values: dict[str, str]) -> list[ComparisonRow]:
        rows: list[ComparisonRow] = []
        from apps.receipt_comparison.domain.comparison_display import comparison_row_from_dict
