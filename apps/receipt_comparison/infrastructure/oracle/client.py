...
from apps.gonenkukumi.infrastructure.oracle.client import oracle_connection, rows_as_dicts, use_mock
from apps.receipt_comparison.domain.comparison import normalize_qty
from apps.receipt_comparison.domain.records import MariReceiptRow
