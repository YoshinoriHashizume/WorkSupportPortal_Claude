...
from apps.receipt_comparison.infrastructure.oracle.customers import list_receipt_customers, lookup_receipt_customer_name
from apps.receipt_comparison.infrastructure.oracle.vendors import VENDOR_CODE_DIGIT_LENGTH, list_receipt_vendors, lookup_receipt_vendor_name
