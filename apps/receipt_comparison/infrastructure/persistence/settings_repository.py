...
from apps.receipt_comparison.domain.comparison_urls import is_fixed_digit_code
from apps.receipt_comparison.infrastructure.oracle.receipt_choices import lookup_customer_name, lookup_vendor_name
from apps.receipt_comparison.infrastructure.oracle.vendors import VENDOR_CODE_DIGIT_LENGTH
...
from apps.receipt_comparison.domain.settings_labels import customer_digit_length, settings_target_label
