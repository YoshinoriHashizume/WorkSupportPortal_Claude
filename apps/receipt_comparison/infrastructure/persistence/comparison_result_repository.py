...
from apps.receipt_comparison.infrastructure.persistence.model_registry import comparison_result_model, file_import_model
...
def existing_rows_for_display(
    ...
    from apps.receipt_comparison.infrastructure.persistence.model_registry import supplier_model
