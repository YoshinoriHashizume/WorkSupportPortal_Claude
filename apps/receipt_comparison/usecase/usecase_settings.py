...
from apps.receipt_comparison.domain.comparison_type import SUPPLIED_PARTS, comparison_type_page_label
from apps.receipt_comparison.domain.comparison_urls import settings_redirect_path
from apps.receipt_comparison.domain.ports import ListSuppliersForSettings, ReceiptChoiceGateway, SettingsRepository
from apps.receipt_comparison.domain.settings_labels import settings_exclusion_label, settings_target_label
