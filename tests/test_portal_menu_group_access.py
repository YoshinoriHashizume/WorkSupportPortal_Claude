...
from apps.portal.favorites import can_access_menu_item, menu_groups_with_items
...
def test_general_affairs_user_sees_asset_inventory_in_menu_and_can_open_page(client, monkeypatch):
    from apps.asset_inventory.domain.ports import ListPageResult, ReconcileCounts
