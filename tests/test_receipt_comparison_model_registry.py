...
from apps.receipt_comparison.domain.comparison_type import FINISHED_PRODUCT, SUPPLIED_PARTS, is_finished_product
from apps.receipt_comparison.domain.settings_labels import (
