...
from apps.gonenkukumi.domain.year_month_nav import compare_ym, next_month, normalize_year_month, previous_month
...
from apps.gonenkukumi.templatetags.gonenkukumi_format import quantity
...
def test_fetch_supplier_demand_series_joins_purchase_order(monkeypatch):
    ...
    monkeypatch.setattr("apps.gonenkukumi.infrastructure.oracle.client.oracle_config", lambda: {"company_cd": ""})
