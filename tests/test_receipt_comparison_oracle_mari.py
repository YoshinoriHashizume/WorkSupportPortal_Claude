...
from apps.receipt_comparison.infrastructure.oracle import client as oracle_client
...
def test_verify_mari_shipment_aggregation_script_exists():
    script_path = Path(__file__).resolve().parents[1] / "scripts" / "verify_mari_shipment_aggregation.py"
