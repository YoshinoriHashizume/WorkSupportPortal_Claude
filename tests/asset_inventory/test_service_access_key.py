...
from apps.asset_inventory.domain.errors import format_desknet_user_error_message
from apps.asset_inventory.infrastructure.desknet.service_access_key import (
...
def test_resolve_asset_inventory_access_key_uses_service_account(monkeypatch):
    clear_service_access_key_cache()
    monkeypatch.setattr(
        "apps.asset_inventory.infrastructure.desknet.service_access_key.authenticate_desknet_user",
