...
from applications.inventory_order_alert.domain.alert_level import is_alert_level, resolve_alert_level
from applications.inventory_order_alert.domain.confirmation import ConfirmationRecord, attach_confirmation_fields
...
def sort_summary_rows(rows: list[dict[str, object]]) -> list[dict[str, object]]:
    from applications.inventory_order_alert.domain.alert_level import ALERT_NONE, alert_sort_rank
