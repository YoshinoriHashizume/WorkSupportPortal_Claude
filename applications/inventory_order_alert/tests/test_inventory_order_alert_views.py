...
from applications.inventory_order_alert.infrastructure.persistence.summary_snapshot_repository import store_summary_snapshot
from applications.inventory_order_alert.models import SlimsStockImport
...
@pytest.mark.django_db
@patch("applications.inventory_order_alert.infrastructure.persistence.slims_stock_repository.run_summary_aggregation")
...
def test_list_page_alert_counts_include_confirmed_rows(client, production_user):
    ...
    from applications.inventory_order_alert.models import ConfirmationStatus, InventoryOrderAlertConfirmation
...
@pytest.mark.django_db
@patch("applications.inventory_order_alert.composition.portal_dashboard_usecase")
def test_dashboard_shows_inventory_order_alert_banner(mock_usecase_factory, client, production_user):
    from applications.inventory_order_alert.usecase.usecase_portal_dashboard import DashboardBannerContext
