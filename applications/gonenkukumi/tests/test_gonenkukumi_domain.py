...
from applications.gonenkukumi.domain.schemas import validate_search_params
from applications.gonenkukumi.domain.year_month_nav import compare_ym, next_month, normalize_year_month, previous_month
...
from applications.gonenkukumi.templatetags.gonenkukumi_format import quantity
...
def test_fetch_supplier_demand_series_joins_purchase_order(monkeypatch):
    ...
    monkeypatch.setattr("applications.gonenkukumi.infrastructure.oracle.client.oracle_config", lambda: {"company_cd": ""})
