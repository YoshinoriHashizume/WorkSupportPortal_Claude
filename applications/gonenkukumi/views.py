...
from applications.portal.favorites import favorite_keys_for_user
...
from applications.gonenkukumi.composition import (
...
def _oracle_error_http_status(exc: OracleQueryError) -> int:
    from applications.gonenkukumi.domain.errors import NAISAK_NOT_FOUND
