...
from applications.identity.domain.user_info import DesknetUserInfo
from applications.identity.infrastructure.desknet.client import desknet_login_api_url
from applications.portal.models import UserAccessRequest
...
def test_desknet_login_creates_user_bound_by_employee_id(client, monkeypatch, settings):
    ...
    monkeypatch.setattr("applications.identity.infrastructure.desknet.client.authenticate_desknet_user", fake_authenticate)
...
def test_login_page_shows_dev_login_when_auth_dev_mode(client, settings):
    ...
    from applications.portal.composition import bootstrap_local_dev_usecase
    from applications.portal.domain.bootstrap import BootstrapLocalDevConfig
...
def test_login_page_hides_dev_login_when_non_bootstrap_admin_exists(client, settings):
    ...
    from applications.portal.composition import bootstrap_local_dev_usecase
    from applications.portal.domain.bootstrap import BootstrapLocalDevConfig
    from applications.portal.favorites import ADMIN_GROUP_NAME
