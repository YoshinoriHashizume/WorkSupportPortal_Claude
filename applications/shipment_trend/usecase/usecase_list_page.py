...
from applications.portal.domain.list_table import build_table_query_string
from applications.shipment_trend.domain.alert_tier import build_alert_rule_rows
from applications.shipment_trend.domain.list_client_data import build_list_client_payload
from applications.shipment_trend.domain.list_rows import enrich_rows
from applications.shipment_trend.domain.list_filter import (
    ListFilterParams,
    apply_list_filters,
...
from applications.shipment_trend.domain.ports import LoadAppSettings, LoadLatestRows
from applications.shipment_trend.domain.table_display import (
    PAGE_SIZE_OPTIONS,
    apply_table_display,
    build_sort_links,
    parse_page_params,
...
from applications.shipment_trend.domain.trend_metrics import hydrate_rows_metrics
...
class ListPageUsecase:
    def __init__(
        ...
        refresh_data: RefreshDataUsecase,
    ) -> None:
