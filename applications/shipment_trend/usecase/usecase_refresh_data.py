...
from applications.shipment_trend.domain.ports import RunAggregation
from applications.shipment_trend.infrastructure.persistence.summary_snapshot_repository import create_refresh_record
