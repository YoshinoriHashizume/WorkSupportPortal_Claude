...
from applications.shipment_trend.domain.trend_builder import build_trend_rows
from applications.shipment_trend.infrastructure.oracle.shipment_queries import (
    fetch_customer_names,
    fetch_monthly_shipments,
)
from applications.shipment_trend.infrastructure.persistence.summary_snapshot_repository import store_summary_snapshot
from applications.shipment_trend.models import ShipmentTrendRefresh
