...
from applications.shipment_trend.domain.app_settings import AppSettings, DEFAULT_DECREASE_THRESHOLD_PCT, DEFAULT_INCREASE_THRESHOLD_PCT
from applications.shipment_trend.models import ShipmentTrendSettings
