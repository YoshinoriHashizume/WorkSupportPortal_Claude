...
from applications.shipment_trend.domain.export_csv import (
    CSV_BASE_COLUMNS,
    build_csv_export,
    build_month_range,
    format_monthly_cell,
...
def test_csv_base_columns_item_cd_label():
    from applications.shipment_trend.domain.export_csv import CSV_BASE_COLUMNS
    from applications.shipment_trend.domain.table_display import COLUMN_LABELS
