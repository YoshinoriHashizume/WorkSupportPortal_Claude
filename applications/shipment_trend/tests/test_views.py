...
from applications.shipment_trend.domain.summary import SummaryLoadResult
...
@patch("applications.shipment_trend.infrastructure.persistence.summary_repository.load_latest_summary")
