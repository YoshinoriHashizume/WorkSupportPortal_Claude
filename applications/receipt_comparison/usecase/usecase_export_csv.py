...
from applications.receipt_comparison.domain.comparison_display import DisplayRow
from applications.receipt_comparison.domain.constants import RESULT_COLUMNS
from applications.receipt_comparison.domain.ports import PendingComparisonStore
from applications.receipt_comparison.usecase.usecase_comparison_page import ComparisonPageUsecase, comparison_export_filename
...
class ExportCsvUsecase:
    def __init__(self, comparison_page_usecase: ComparisonPageUsecase) -> None:
