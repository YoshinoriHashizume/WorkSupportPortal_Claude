...
from applications.receipt_comparison.infrastructure.oracle.vendors import (
    VENDOR_CODE_DIGIT_LENGTH,
    list_receipt_vendors,
    lookup_receipt_vendor_name,
)
from applications.receipt_comparison.infrastructure.oracle.receipt_choices import list_vendor_choices
