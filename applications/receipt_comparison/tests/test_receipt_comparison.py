...
from applications.portal.favorites import (
    is_menu_path_active,
    receipt_comparison_menu_key,
    receipt_comparison_type_from_path,
)
from applications.portal.middleware import receipt_comparison_menu_key_for_request
from applications.portal.models import PortalMenuGroupAccess
from applications.receipt_comparison.domain.comparison import compare_receipts, normalize_qty
from applications.receipt_comparison.domain.file_parser import parse_receipt_file
from applications.receipt_comparison.domain.records import MariReceiptRow, ReceiptFileRow
...
from applications.receipt_comparison.domain.comparison_type import is_finished_product
...
from applications.receipt_comparison.domain.comparison_urls import is_results_panel_active, settings_redirect_path
from applications.receipt_comparison.domain.settings_labels import settings_target_label
from applications.receipt_comparison.infrastructure.oracle.receipt_choices import list_customer_choices, list_vendor_choices
from applications.receipt_comparison.infrastructure.persistence.supplier_lookup import receiving_places_for_supplier
from applications.receipt_comparison.usecase.usecase_comparison_page import comparison_export_filename
...
def test_receipt_comparison_compare_does_not_save_until_register(client, production_user, supplier, monkeypatch):
    ...
    monkeypatch.setattr("applications.receipt_comparison.infrastructure.oracle.client.fetch_mari_rows", fake_fetch_mari_rows)
    client.force_login(production_user)
