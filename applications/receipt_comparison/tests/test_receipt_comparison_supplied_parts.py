...
from applications.receipt_comparison.domain.file_parser import (
...
from applications.gonenkukumi.infrastructure.oracle.customers import (
...
def test_supplied_parts_compare_warns_when_file_has_no_matching_rows(
    ...
    monkeypatch.setattr("applications.receipt_comparison.infrastructure.oracle.client.fetch_mari_rows", lambda **kwargs: [])
    client.force_login(production_user)
