...
from applications.receipt_comparison.infrastructure.session import pending_comparison_session as session
...
class HttpPendingComparisonStore:
    ...
    def rows_for_register(self, pending: dict[str, object], post_values: dict[str, str]) -> list[ComparisonRow]:
        rows: list[ComparisonRow] = []
        from applications.receipt_comparison.domain.comparison_display import comparison_row_from_dict
