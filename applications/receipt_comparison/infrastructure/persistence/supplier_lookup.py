...
from applications.receipt_comparison.infrastructure.persistence.supplier_repository import (
    mari_vendor_codes_for_supplier,
    vendor_match_codes_for_supplier,
)
from applications.receipt_comparison.models import FinishedProductReceiptSupplier, SuppliedPartsReceiptSupplier
