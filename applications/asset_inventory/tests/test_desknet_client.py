...
from applications.asset_inventory.infrastructure.desknet.client import (
    appsr_api_url,
...
def test_TC_AIV_INF_007_fetch_list_data_page_uses_post(monkeypatch):
    ...
    monkeypatch.setattr("applications.asset_inventory.infrastructure.desknet.client.urllib.request.urlopen", fake_urlopen)

    from applications.asset_inventory.infrastructure.desknet.client import fetch_list_data_page
...
def test_TC_AIV_INF_001_paging(monkeypatch):
    ...
    monkeypatch.setattr(
        "applications.asset_inventory.infrastructure.desknet.client.fetch_list_data_page",
