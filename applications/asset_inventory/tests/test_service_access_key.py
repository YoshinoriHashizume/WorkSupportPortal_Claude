...
from applications.asset_inventory.domain.errors import format_desknet_user_error_message
from applications.asset_inventory.infrastructure.desknet.service_access_key import (
...
def test_format_desknet_user_error_message_for_w10008_without_service_account():
    message = format_desknet_user_error_message("W:アクセス権がありません。[W10008]")
...
def test_resolve_asset_inventory_access_key_uses_service_account(monkeypatch):
    clear_service_access_key_cache()
    monkeypatch.setattr(
        "applications.asset_inventory.infrastructure.desknet.service_access_key.authenticate_desknet_user",
