...
from applications.asset_inventory.domain.sort_headers import TableHeader, build_table_headers
from applications.asset_inventory.domain.table_display import SortSpec, TableDisplayParams
