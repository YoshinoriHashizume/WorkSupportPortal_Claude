...
from applications.portal.composition import favorites_usecase, menu_access_usecase
from applications.portal.domain.menu_access import (
    is_menu_path_active,
    menu_title,
    receipt_comparison_menu_key,
    receipt_comparison_type_from_path,
)
from applications.portal.domain.constants import ADMIN_GROUP_NAME, MANAGEMENT_GROUP_KEY, RECEIPT_COMPARISON_MENU_KEYS


def user_group_names(user: object) -> set[str]:
    from applications.portal.composition import get_menu_access_repository
...
def page_favorite_toggle_context(user: object, menu_key: str) -> dict[str, object]:
    from applications.portal.domain.menu import MENU_BY_KEY
