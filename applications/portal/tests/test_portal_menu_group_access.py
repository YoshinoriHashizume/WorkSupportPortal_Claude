...
from applications.portal.domain.menu_access import normalize_menu_group_key
from applications.portal.favorites import can_access_menu_item, menu_groups_with_items
...
def test_general_affairs_user_sees_asset_inventory_in_menu_and_can_open_page(client, monkeypatch):
    from applications.asset_inventory.domain.ports import ListPageResult, ReconcileCounts
    ...
    monkeypatch.setattr(
        "applications.asset_inventory.views.list_page_usecase",
