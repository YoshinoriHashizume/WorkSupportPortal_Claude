...
from applications.portal.management.commands.check_production_env import mask_database_url
from config.settings import load_dotenv

migration_module = importlib.import_module(
    "applications.receipt_comparison.migrations.0004_supplied_parts_customer_code"
)
