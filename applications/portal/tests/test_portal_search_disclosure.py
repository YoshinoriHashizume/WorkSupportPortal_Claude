...
from applications.asset_inventory.domain.ports import ManagementRow
...
def test_asset_inventory_renders_search_disclosure(client, general_affairs_user, monkeypatch):
    ...
    monkeypatch.setattr("applications.asset_inventory.views.build_table_headers", lambda **kwargs: [])
    monkeypatch.setattr("applications.asset_inventory.views.build_row_color_rule_rows", lambda: [])
