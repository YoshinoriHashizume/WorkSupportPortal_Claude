...
from application.shipment_trend.models import ShipmentTrendRefresh, ShipmentTrendSummarySnapshot
...
@patch("application.shipment_trend.infrastructure.persistence.summary_repository.load_latest_summary")
