...
from application.receipt_comparison.domain.value_objects.comparison_type import SUPPLIED_PARTS, comparison_type_page_label
from application.receipt_comparison.domain.value_objects.comparison_urls import settings_redirect_path
from application.receipt_comparison.domain.repositories.ports import ListSuppliersForSettings, ReceiptChoiceGateway, SettingsRepository
from application.receipt_comparison.domain.value_objects.settings_labels import settings_exclusion_label, settings_target_label
