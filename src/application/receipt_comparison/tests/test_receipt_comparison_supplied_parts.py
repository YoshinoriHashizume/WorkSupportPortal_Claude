...
from application.receipt_comparison.domain.value_objects.file_parser import (
...
from .test_receipt_comparison import assert_results_head_button_order
...
def test_supplied_parts_compare_warns_when_file_has_no_matching_rows(
    ...
    monkeypatch.setattr("application.receipt_comparison.infrastructure.oracle.client.fetch_mari_rows", lambda **kwargs: [])
    client.force_login(production_user)
