...
from application.receipt_comparison.domain.value_objects.comparison_type import FINISHED_PRODUCT, SUPPLIED_PARTS, is_finished_product
from application.receipt_comparison.domain.value_objects.settings_labels import (
