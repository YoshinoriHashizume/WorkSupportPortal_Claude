...
from application.portal.interfaces.middleware import receipt_comparison_menu_key_for_request
from application.portal.models import PortalMenuGroupAccess
from application.receipt_comparison.domain.value_objects.comparison import compare_receipts, normalize_qty
from application.receipt_comparison.domain.value_objects.file_parser import parse_receipt_file
...
from application.receipt_comparison.domain.value_objects.comparison_urls import is_results_panel_active, settings_redirect_path
from application.receipt_comparison.domain.value_objects.settings_labels import settings_target_label
from application.receipt_comparison.infrastructure.oracle.receipt_choices import list_customer_choices, list_vendor_choices
from application.receipt_comparison.infrastructure.persistence.supplier_lookup import receiving_places_for_supplier
from application.receipt_comparison.use_cases.comparison_page import comparison_export_filename
...
def test_receipt_comparison_compare_does_not_save_until_register(client, production_user, supplier, monkeypatch):
    ...
    monkeypatch.setattr("application.receipt_comparison.infrastructure.oracle.client.fetch_mari_rows", fake_fetch_mari_rows)
    client.force_login(production_user)
