...
if TYPE_CHECKING:
    from application.asset_inventory.domain.value_objects.row_detail import FieldDiffItem
    from application.asset_inventory.domain.value_objects.table_display import SortSpec
