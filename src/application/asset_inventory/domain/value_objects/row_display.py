...
from application.asset_inventory.domain.value_objects.dates import format_asset_acquisition_date_display
from application.asset_inventory.domain.value_objects.plate_display import format_plate_created
from application.asset_inventory.domain.value_objects.row_detail import build_field_comparisons
...
def map_record_to_display(
    ...
    *,
    ...
    return ReconcileRow(
        ...
        site_code=source.get("管理部門コード", ""),
        manufacturer=source.get("メーカー", ""),
        manufacturer_code=source.get("メーカーコード", ""),
        model_name=source.get("管理者名称", ""),
        manager_code=source.get("管理者コード", ""),
        ...
        usage_category_code=source.get("使用区分コード", ""),
