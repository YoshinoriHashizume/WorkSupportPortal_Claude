...
def test_TC_AIV_INF_007_fetch_list_data_page_uses_post(monkeypatch):
    ...
    monkeypatch.setattr("application.asset_inventory.infrastructure.desknet.client.urllib.request.urlopen", fake_urlopen)
...
def test_TC_AIV_INF_001_paging(monkeypatch):
    ...
    monkeypatch.setattr(
        "application.asset_inventory.infrastructure.desknet.client.fetch_list_data_page",
