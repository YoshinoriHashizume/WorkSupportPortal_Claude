...
from application.asset_inventory.domain.value_objects.attachment_proxy import (
...
def test_TC_AIV_DOM_066_fetch_attachment_content(monkeypatch):
    ...
    monkeypatch.setattr(
        "application.asset_inventory.domain.value_objects.attachment_proxy.urllib.request.urlopen",
        fake_urlopen,
    )
