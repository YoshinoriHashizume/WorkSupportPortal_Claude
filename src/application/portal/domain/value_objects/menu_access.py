...
from application.portal.domain.value_objects.constants import MANAGEMENT_GROUP_KEY, RECEIPT_COMPARISON_PATH, RECEIPT_COMPARISON_MENU_KEYS
from application.portal.domain.value_objects.menu import MENU_BY_KEY, MENU_GROUP_BY_KEY, MENU_GROUP_KEY_BY_TITLE, MENU_ITEMS, PortalMenuItem
