...
from application.portal.interfaces.favorites import can_access_menu_item, is_menu_path_active, menu_groups_with_items
from application.portal.interfaces.views import delete_portal_user
from application.portal.models import PortalMenuGroupAccess, PortalNotice, UserAccessRequest, UserFavoriteMenu
