# Review Skills — README

レビュー用のClaude Codeカスタムスキル群。
機能設計レビュー（design-review-l1）、テスト設計レビュー（test-design-review-l1）、
実装レビュー（implement-review-l1）でレビューを実施する。
...
| **test-design-review-l1** | テスト設計書（test-design.md） | 「テスト設計レビューをお願い」「テスト設計のレビューをして」 |
| **implement-review-l1** | 実装コード | 「実装レビューをお願い」「実装レビューをして」 |

推奨フロー: **design-review-l1 → test-design-review-l1 → 実装 → implement-review-l1**
...
## test-design-review-l1（テスト設計レビュー）
...
|-----------------|-----------------|
| swift-clean-architecture.md | make-design ↔ design-review-l1 ↔ implement-review-l1 |
| django-clean-architecture.md | 同上 |
| csharp-clean-architecture.md | 同上 |
| test-strategy.md | make-test-design ↔ test-design-review-l1 |
...
cp make-design/references/swift-clean-architecture.md implement-review-l1/references/

# 例: test-strategy.md を更新した場合
cp make-test-design/references/test-strategy.md test-design-review-l1/references/
```
...
cp -r test-design-review-l1/ .claude/skills/test-design-review-l1/
cp -r implement-review-l1/ .claude/skills/implement-review-l1/
```
